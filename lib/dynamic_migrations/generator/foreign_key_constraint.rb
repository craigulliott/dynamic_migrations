  ...
  class Generator
    module ForeignKeyConstraint
      def add_foreign_key_constraint foreign_key_constraint
        ...
        add_migration foreign_key_constraint.table.schema.name, foreign_key_constraint.table.name, "validate_#{foreign_key_constraint.name}_on_#{foreign_key_constraint.table.name}", <<~RUBY
          add_foreign_key_constraint :#{foreign_key_constraint.table.name}, #{column_names}, :#{foreign_key_constraint.foreign_table.name}, #{foreign_column_names}, #{options_syntax}
        RUBY
      end

      def remove_foreign_key_constraint foreign_key_constraint
        add_migration foreign_key_constraint.table.schema.name, foreign_key_constraint.table.name, "remove_#{foreign_key_constraint.name}_from_#{foreign_key_constraint.table.name}", <<~RUBY
