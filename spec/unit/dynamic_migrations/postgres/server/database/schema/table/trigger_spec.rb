...
RSpec.describe DynamicMigrations::Postgres::Server::Database::Schema::Table::Trigger do
  ...
  let(:trigger) { DynamicMigrations::Postgres::Server::Database::Schema::Table::Trigger.new :configuration, table, :trigger_name, event_manipulation: :insert, action_order: 1, action_condition: nil, action_statement: "EXECUTE FUNCTION checklists.foo()", action_orientation: :row, action_timing: :before, function_schema: :my_schema, function_name: :function_name, function_definition: "SQL" }
  ...
  describe :initialize do
    ...
    describe "providing an optional description" do
      it "does not raise an error" do
        expect {
          DynamicMigrations::Postgres::Server::Database::Schema::Table::Trigger.new :configuration, table, :trigger_name, event_manipulation: :insert, action_order: 1, action_condition: nil, action_statement: "EXECUTE FUNCTION checklists.foo()", action_orientation: :row, action_timing: :before, function_schema: :my_schema, function_name: :function_name, function_definition: "SQL", description: "foo bar"
        }.to_not raise_error
      end
    ...
    it "raises an error if providing an invalid table" do
      expect {
        DynamicMigrations::Postgres::Server::Database::Schema::Table::Trigger.new :configuration, :not_a_table, :trigger_name, event_manipulation: :insert, action_order: 1, action_condition: nil, action_statement: "EXECUTE FUNCTION checklists.foo()", action_orientation: :row, action_timing: :before, function_schema: :my_schema, function_name: :function_name, function_definition: "SQL"
    ...
    it "raises an error if providing something other than a symbol for the trigger name" do
      expect {
        DynamicMigrations::Postgres::Server::Database::Schema::Table::Trigger.new :configuration, table, "invalid trigger name", event_manipulation: :insert, action_order: 1, action_condition: nil, action_statement: "EXECUTE FUNCTION checklists.foo()", action_orientation: :row, action_timing: :before, function_schema: :my_schema, function_name: :function_name, function_definition: "SQL"
    ...
    it "raises an error if providing an unexpected value for the event_manipulation" do
      expect {
        DynamicMigrations::Postgres::Server::Database::Schema::Table::Trigger.new :configuration, table, :trigger_name, event_manipulation: :unexpected_value, action_order: 1, action_condition: nil, action_statement: "EXECUTE FUNCTION checklists.foo()", action_orientation: :row, action_timing: :before, function_schema: :my_schema, function_name: :function_name, function_definition: "SQL"
    ...
    it "raises an error if providing an unexpected value for the action_order" do
      expect {
        DynamicMigrations::Postgres::Server::Database::Schema::Table::Trigger.new :configuration, table, :trigger_name, event_manipulation: :insert, action_order: nil, action_condition: nil, action_statement: "EXECUTE FUNCTION checklists.foo()", action_orientation: :row, action_timing: :before, function_schema: :my_schema, function_name: :function_name, function_definition: "SQL"
    ...
    it "raises an error if providing an unexpected value for the action_condition" do
      expect {
        DynamicMigrations::Postgres::Server::Database::Schema::Table::Trigger.new :configuration, table, :trigger_name, event_manipulation: :insert, action_order: 1, action_condition: 123, action_statement: "EXECUTE FUNCTION checklists.foo()", action_orientation: :row, action_timing: :before, function_schema: :my_schema, function_name: :function_name, function_definition: "SQL"
    ...
    it "raises an error if providing an unexpected value for the action_statement" do
      expect {
        DynamicMigrations::Postgres::Server::Database::Schema::Table::Trigger.new :configuration, table, :trigger_name, event_manipulation: :insert, action_order: 1, action_condition: nil, action_statement: "invalid statement", action_orientation: :row, action_timing: :before, function_schema: :my_schema, function_name: :function_name, function_definition: "SQL"
    ...
    it "raises an error if providing an unexpected value for the action_orientation" do
      expect {
        DynamicMigrations::Postgres::Server::Database::Schema::Table::Trigger.new :configuration, table, :trigger_name, event_manipulation: :insert, action_order: 1, action_condition: nil, action_statement: "EXECUTE FUNCTION checklists.foo()", action_orientation: :unexpected_value, action_timing: :before, function_schema: :my_schema, function_name: :function_name, function_definition: "SQL"
    ...
    it "raises an error if providing an unexpected value for the action_timing" do
      expect {
        DynamicMigrations::Postgres::Server::Database::Schema::Table::Trigger.new :configuration, table, :trigger_name, event_manipulation: :insert, action_order: 1, action_condition: nil, action_statement: "EXECUTE FUNCTION checklists.foo()", action_orientation: :row, action_timing: :unexpected_value, function_schema: :my_schema, function_name: :function_name, function_definition: "SQL"
      }.to raise_error DynamicMigrations::Postgres::Server::Database::Schema::Table::Trigger::UnexpectedActionTimingError
    end

    it "raises an error if providing an unexpected value for the function_schema" do
      expect {
        DynamicMigrations::Postgres::Server::Database::Schema::Table::Trigger.new :configuration, table, :trigger_name, event_manipulation: :insert, action_order: 1, action_condition: nil, action_statement: "EXECUTE FUNCTION checklists.foo()", action_orientation: :row, action_timing: :before, function_schema: nil, function_name: :function_name, function_definition: "SQL"
      }.to raise_error DynamicMigrations::ExpectedSymbolError
    end

    it "raises an error if providing an unexpected value for the function_name" do
      expect {
        DynamicMigrations::Postgres::Server::Database::Schema::Table::Trigger.new :configuration, table, :trigger_name, event_manipulation: :insert, action_order: 1, action_condition: nil, action_statement: "EXECUTE FUNCTION checklists.foo()", action_orientation: :row, action_timing: :before, function_schema: :my_schema, function_name: nil, function_definition: "SQL"
      }.to raise_error DynamicMigrations::ExpectedSymbolError
    end

    it "raises an error if providing an unexpected value for the function_definition" do
      expect {
        DynamicMigrations::Postgres::Server::Database::Schema::Table::Trigger.new :configuration, table, :trigger_name, event_manipulation: :insert, action_order: 1, action_condition: nil, action_statement: "EXECUTE FUNCTION checklists.foo()", action_orientation: :row, action_timing: :before, function_schema: :my_schema, function_name: :function_name, function_definition: :unexpected_value
      }.to raise_error DynamicMigrations::ExpectedStringError
    end

    it "raises an error if providing an unexpected value for the action_reference_old_table" do
      expect {
        DynamicMigrations::Postgres::Server::Database::Schema::Table::Trigger.new :configuration, table, :trigger_name, event_manipulation: :insert, action_order: 1, action_condition: nil, action_statement: "EXECUTE FUNCTION checklists.foo()", action_orientation: :row, action_timing: :before, function_schema: :my_schema, function_name: :function_name, function_definition: :unexpected_value, action_reference_old_table: 123
      }.to raise_error DynamicMigrations::ExpectedStringError
    end

    it "raises an error if providing an unexpected value for the action_reference_new_table" do
      expect {
        DynamicMigrations::Postgres::Server::Database::Schema::Table::Trigger.new :configuration, table, :trigger_name, event_manipulation: :insert, action_order: 1, action_condition: nil, action_statement: "EXECUTE FUNCTION checklists.foo()", action_orientation: :row, action_timing: :before, function_schema: :my_schema, function_name: :function_name, function_definition: :unexpected_value, action_reference_new_table: 123
      }.to raise_error DynamicMigrations::ExpectedStringError
    end
  end
  ...
  describe :function_schema do
    it "returns the expected function_schema" do
      expect(trigger.function_schema).to eq(:my_schema)
    end
  end

  describe :function_name do
    it "returns the expected function_name" do
      expect(trigger.function_name).to eq(:function_name)
    end
  end

  describe :function_definition do
    it "returns the expected function_definition" do
      expect(trigger.function_definition).to eq("SQL")
    end
  end
