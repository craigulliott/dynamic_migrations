...
RSpec.describe DynamicMigrations::Postgres::Server::Database::Schema::Table::Column do
  ...
  let(:column) { DynamicMigrations::Postgres::Server::Database::Schema::Table::Column.new :configuration, table, :my_column, :integer }
  ...
  describe :initialize do
    ...
    it "raises an error if providing an invalid schema" do
      expect {
        DynamicMigrations::Postgres::Server::Database::Schema::Table::Column.new :configuration, "not a schema object", :my_column, :integer
